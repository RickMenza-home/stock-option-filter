...
def fetch_options():
    ...
    for option in results:
        ...
        # Profit potential = premium received (last_price) * 100 shares
        premium = last_price * 100
        margin = strike * 100  # required cash to buy stock if assigned
...
# Table
columns = ("Symbol", "Strike", "Expiration", "Last Price", "Premium", "Margin", "Profit %")
